...
<div class="container">
  ...
  <div class="row">
    ...
    <div class="col-md-9" name="maincontent" id="maincontent">
		...
		<div class="panel-heading"><h5>Search Member</h5></div>
			...
			<!-- ***********Edit your content STARTS from here******** -->
				...
				<form class="form-inline" role="form" name="" action="" method="GET">
					<div class="form-group">
					  <input class="form-control" name="memname" type="text" placeholder="Member Name... ?>" required>
				...
				//Create SQL query
					...
					$query="select *
					from members where FName like '%$memname%' or LName like '%$memname%'";
					//Execute the query
				...
				{
					echo ("Sorry, seems that no record found by the ID $memname...<br>");
				}//end no record
				else
				{//there is/are record(s)
				?>
					<h5>Search result for the Member "<?php echo $memname; ?>"</h5><br>
				...
				?>
					<tr>
						...
						$id=$rekod['StudentId'];
						//echo $id;
						$urlview="member-record.php?id=$id";
						?>
						<a href="<?php echo $urlview?>" class="btn" title="Member Record" 
						data-toggle="tooltip" > 
							<span class="fui-window"></span></a>
						
						</td>
						<td><?php echo $rekod['StudentId']?></td>
						<td><?php echo $rekod['FName']." ".$rekod['LName']?></td>
