			...
			<!-- ***********Edit your content STARTS from here******** -->
				...
				<form class="form-inline" role="form" name="" action="" method="GET">
					<div class="form-group">
					  <input class="form-control" name="memid" type="text" placeholder="Member ID... ?>" required>
				...
				{
					echo ("Sorry, seems that no record found by the ID $memid...<br>");
				}//end no record
				else
				{//there is/are record(s)
				?>
					<h5>Search result for the Member "<?php echo $memid; ?>"</h5><br>
